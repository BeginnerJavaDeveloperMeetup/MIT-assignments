...
public class MagicSquares {
    ...
    private void processFiles(ArrayList<ArrayList<String>> fileList) {
        ...
        for (ArrayList<String> currFile: fileList) {
            ...
            final SimpleDraw content = new SimpleDraw(new DrawGraphics(myChkSqr));

            content.drawArrayWindow();
        }
    }

    private ArrayList<ArrayList<String>> loadFileArray(){
    ...
    public static void main (String args[]){
        ...
        ArrayList<ArrayList<String>> filesToCheckList = mySquare.loadFileArray();
